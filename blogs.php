...
<body>
    ...
    <div class="container-fluid bg-light p-0 home-intro ">
        <h1 class="text-center text-primary py-5 font-weight-bolder">Our Latest Blogs</h1>
        <div class="container mx-auto p-0">
            <div class="card mt-5" >
                <div class="row no-gutters ">
                  <div class="col-md-4 position-relative d-flex flex-fill">
                      <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">02 June, 2022</p>
                    <img src="./assets/img/1.png" class="w-100" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body bg-dark text-white">
                      <h4 class="card-title font-weight-bold my-4">Short Hand Writing Training</h4>
                      <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                    </div>
                  </div>
                </div>
          </div>
          <div class="card mt-5" >
                <div class="row no-gutters ">
                  <div class="col-md-4 position-relative d-flex flex-fill">
                      <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">12 May, 2022</p>
                    <img src="./assets/img/2.png" class="w-100" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body bg-dark text-white">
                      <h4 class="card-title font-weight-bold my-4">Backend Python Programming </h4>
                      <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card mt-5" >
                  <div class="row no-gutters ">
                    <div class="col-md-4 position-relative d-flex flex-fill">
                        <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">24 April, 2022</p>
        ...
        <div class="container mx-auto p-0">
            <div class="card mt-5" >
                <div class="row no-gutters ">
                  <div class="col-md-4 position-relative d-flex flex-fill">
                      <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">17 Feb, 2022</p>
                    <img src="./assets/img/4.png" class="w-100" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body bg-dark text-white">
                      <h4 class="card-title font-weight-bold my-4">UX | UI and Graphic desiging</h4>
                      <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card mt-5" >
                <div class="row no-gutters ">
                  <div class="col-md-4 position-relative d-flex flex-fill">
                      <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">07 Feb, 2022</p>
                    <img src="./assets/img/5.png" class="w-100" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body bg-dark text-white">
                      <h4 class="card-title font-weight-bold my-4">Web Graphics & Mobile app development</h4>
                      <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card mt-5" >
                  <div class="row no-gutters ">
                    <div class="col-md-4 position-relative d-flex flex-fill">
                        <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">29 Jan, 2022</p>
                      <img src="./assets/img/freelancing.png" class="w-100" alt="...">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body bg-dark text-white">
                        <h4 class="card-title font-weight-bold my-4">Work From Home Freelancing Course</h4>
                        <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                      </div>
                    </div>
                  </div>
        ...
        <div class="container mx-auto p-0">
            <div class="card mt-5" >
                <div class="row no-gutters ">
                  <div class="col-md-4 position-relative d-flex flex-fill">
                      <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">26 Oct, 2021</p>
                    <img src="./assets/img/headway-5QgIuuBxKwM-unsplash.jpg" class="w-100" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body bg-dark text-white">
                      <h4 class="card-title font-weight-bold my-4">Hunnar mand Jawaan program</h4>
                      <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                    </div>
                  </div>
                </div>
          </div>
          <div class="card mt-5" >
                <div class="row no-gutters ">
                  <div class="col-md-4 position-relative d-flex flex-fill">
                      <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">16 sept, 2021</p>
                    <img src="./assets/img/henry-co-3JFVNo4ukKQ-unsplash.jpg" class="w-100" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body bg-dark text-white">
                      <h4 class="card-title font-weight-bold my-4">Chinnese Language Orientation</h4>
                      <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card mt-5" >
                  <div class="row no-gutters ">
                    <div class="col-md-4 position-relative d-flex flex-fill">
                        <p class="lead bg-success d-inline position-absolute first-blog m-0 px-2 py-1 text-white">12 aug, 2021</p>
                      <img src="./assets/img/clark-tibbs-oqStl2L5oxI-unsplash.jpg" class="w-100" alt="...">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body bg-dark text-white">
                        <h4 class="card-title font-weight-bold my-4">Huawei software development</h4>
                        <p class="card-text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore laboriosam maiores doloribus eos? Maiores ullam temporibus vero sit.</p>
                      </div>
                    </div>
                  </div>
